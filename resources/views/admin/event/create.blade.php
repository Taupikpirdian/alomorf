  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12"></br></br>
        {!! Form::open(['action' => 'admin\EventController@store', 'files' => true, 'method' => 'post']) !!}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("start", "Start", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text("start", '',['class' => 'form-control required', 'id' => 'datepicker']) }}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("end", "End", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text("end", '',['class' => 'form-control required', 'id' => 'datepicker2']) }}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("theme", "Theme", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text("theme", '',['class' => 'form-control required']) }}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("text", "Detail", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-10'>
                {{ Form::textarea("text", '',['class' => 'form-control ckeditor required']) }}
