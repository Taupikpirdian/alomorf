...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        {!! Form::model($books,['method'=>'put','action'=>['event\BookController@update',$events->id_evn]]) !!}
          <div class='form-group clearfix'>
            {{ Form::label("id_evn", "ID", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text("id_evn", null,['class' => 'form-control required']) }}
                <span class="error">{{$errors->first('id_evn')}}</span>
              </div>
          </div>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("tgl_msk", "Tanggal Masuk", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
