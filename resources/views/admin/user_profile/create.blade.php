  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12"></br></br>
        {!! Form::open(['action' => 'admin\UserProfileController@store', 'files' => true]) !!}
          <div class='form-group clearfix'>
              {{ Form::label("id_user", "ID User", ['class' => 'col-md-2 control-label']) }}
                <div class='col-md-4'>
                   {{ Form::select('id_user', $users, null,['class' => 'form-control required', 'placeholder' => 'Pilih user']) }}
                  <span class="error" style="color: red;">{{$errors->first('id_user')}}</span>
                </div>
            </div>
          ...
          <div class='form-group clearfix'>
            {{ Form::label("nomor_hp", "Nomor Hp", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text("nomor_hp", '',['class' => 'form-control required']) }}
          ...
          <div class='form-group clearfix'>
            {{ Form::label("tempat_lahir", "Tempat Lahir", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-4'>
                {{ Form::text('tempat_lahir', '', ['class' => 'form-control required']) }}
          ...
          <!-- <div class='form-group clearfix'>
            ...
            <div class='col-md-4'>
                  <div class="input-group">
                    ...
                    <input id="thumbnail" class="form-control" type="text" name="foto_profile">
                  </div>
